...
while portfolio_return == 0: # a hack to avoid stationary case
    ...
    for t in range(1, trading_period + 1):
        ...
        print('actions:', actions) #Turned on, commented out 
        print('chosen action:', action) # Turned on, previously commented out. 
...
if display:
    plot_portfolio_transaction_history(stock_name, agent) # Turned on, oommented off in default
    plot_portfolio_performance_comparison(stock_name, agent) # Previously commented out. 
