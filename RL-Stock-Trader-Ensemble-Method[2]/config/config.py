...
#TRAINED_MODEL_DIR = f"trained_models/TestRun" # 1/100th size zone
#TRAINED_MODEL_DIR = f"trained_models/2xTestRun" # / 2x size zone. 
TRAINED_MODEL_DIR = f"trained_models/100thRun2" # / 1/100th size zone. 
